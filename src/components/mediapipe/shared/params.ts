...
export type StateTypeCamera = { targetFPS: number; sizeOption: string };
...
export type StateType = {
  ...
  backend: string;
  flags: any;
  modelConfig: (MediaPipeHandsMediaPipeModelConfig | MediaPipeHandsTfjsModelConfig ) & { scoreThreshold?: number, render3D?: boolean, maxNumHands?: number } ;
